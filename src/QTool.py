...
class QTool(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None, name="", description="", demoImagePath=None, onRun=None, toolInput=None, onCompleted=None, toolReference=None):
        ...
        #tool label backgorund colour
        self.titleLabel.setStyleSheet("""
            QLabel {
                background-color: rgba(92, 32, 139, 0.2);
                font-size: 40px;
                }
            """)
        ...
        image = image.scaled(350, 350, QtCore.Qt.AspectRatioMode.KeepAspectRatioByExpanding, QtCore.Qt.TransformationMode.SmoothTransformation)
        ...
        for b in buttons:
            #for ai tools button colour
            b.setStyleSheet('''
                border-width: 2px solid;
                border-color: rgb(242, 198, 73);
                background-color:rgba(242, 198, 73, 0.5);
                height: 30px;
                width: 100px;
            ''')
